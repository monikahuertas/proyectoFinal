...
export default function UpdateProducts({idUpdate ,load, setLoad}) {
  ...
  const getProductsById= async(id) =>{
    const response = await axios.get (`http://localhost:3000/api/products/getProductsById/${id}`)
